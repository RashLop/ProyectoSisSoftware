...
describe("TicketParking", () => {
    ...
    it("se debe de ingresar una hora de entrada y salida", () => {
        ...
        expect(ticket.mostrar()).toEqual("De 9/9/2025, 10:30:00 hasta 9/9/2025, 10:40:00"); 
    });
    ...
    it("Se debe de mostrar la hora de entrada y salida", () => {
        ...
        let ticket = new ticketParking(test,test2); 
        expect(ticket.mostrar()).toEqual("De 9/9/2025, 10:30:00 hasta 9/9/2025, 10:50:00");  
    }); 
    ...
    it("al ingresar datos similares, lanzar un mensaje de error", () => {
        ...
        expect(ticket.mostrar()).toEqual("Error, no se puede ingresar fechas iguales"); 
    });
    ...
    it("Si se pone una hora de salida anterior a la entrada, se da error",() =>{
        ...
        let ticket = new ticketParking(test,test2); 
        expect(ticket.mostrar()).toEqual("Error, la hora de salida no puede ser anterior a la de entrada")
    });
